...
class Banner extends Component {
  ...
  renderBanner = () => {
    ...
    if (this.props.movie) {
      const backDrop = this.props.movie[2].backdrop_path;
      const prefix = "http://image.tmdb.org/t/p/original/";
      const prefixModal = "http://image.tmdb.org/t/p/w342/";
      const posterPath = this.props.movie[2].poster_path;
        ...
        <div className="Home">
          ...
          <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
            ...
            <ModalBody>
              <Row>
                <Col>
                  <h5>{this.props.movie[2].title}</h5>
                </Col>
              </Row>
              <Row>
                <Col className="mb-2">
                  <GiTomato size={25} className="rottenTomato" />
                  {this.props.movie[2].vote_average}/10
                </Col>
              </Row>
              <Row>
                <Col>
                  <p>{this.props.movie[2].overview}</p>
                </Col>
              </Row>
            </ModalBody>
          </Modal>
